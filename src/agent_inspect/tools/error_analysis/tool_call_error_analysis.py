...
class ToolCallErrorAnalysis(
    ErrorAnalysis[ToolCallErrorAnalysisDataSample, ToolCallErrorAnalysisResult]
):
    ...
    async def _classify_single_validation(
        self, validation_result, data_sample_id: int, agent_run_id: int | None
